...
class Waterfall: BaseSuakeNode {
    
    public var isHit:Bool = false
    var game:GameViewController!
    //var animations = [String: CAAnimation]()
    //public var hitByBulletGrp:BulletGrp!
    ...
    required override init(){
        let scene:SCNScene = SCNScene(named: "game.scnassets/waterfall/Rck-Wtrfll_dae.dae")!
        ...
        //self.placeOnBoard(pos: SCNVector3(x: 10, y: 2, z: 12))
        ...
        physicsBody?.contactTestBitMask = CollisionCategory.MouseCategory|CollisionCategory.SuakeCategory|CollisionCategory.RocketCategory|CollisionCategory.BulletCategory
    ...
    func placeOnBoard(pos:SCNVector3){
        ...
        self.position = SCNVector3(x: (self.pos.x * -100), y: self.pos.y * 100 /*self.bbMax.y*/, z: self.pos.z * 100)
